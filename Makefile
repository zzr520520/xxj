...
MyAppWiper_CFLAGS = -fobjc-arc -Wno-unused-variable -Wno-unused-function -Wno-arc-performSelector-leaks -Wno-deprecated-declarations -Wno-unguarded-availability-new -Wl,-sectcreate,__RESTRICT,__restrict,/dev/null
